...
mean_list=[mean_list_d[12], mean_list_r[12]]
std_list=[std_list_d[12], std_list_r[12]]
...
time_to_renege_dist = Lognormal(mean_list_r[12], std_list_r[12], random_seed = 5)
inpatient_los_dist = Lognormal(mean_list_d[12], std_list_d[12], random_seed = 5)
