...
compare_list=[list_of_summary_lists1[0], list_of_summary_lists1[1], list_of_summary_lists2[12+1]] # corresponding summary list is + 1 index
...
compare_list=[list_of_summary_lists4[12+1], list_of_summary_lists4[5+1], list_of_summary_lists4[19+1]]
summary_table1=distribution_functions.summary_lists_to_table(compare_list)
summary_table1.set_index('Metric', inplace=True)
