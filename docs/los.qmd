...
## Do we not just change mean LoS 1?
...
styled_table = summary_table1.style.set_table_attributes('style="width:100%; font-size:0.5em;"')
...
## Do we not just change mean LoS 2?
...
combined_fig.update_layout(
    title={
        'text': 'Decreasing mean, increasing LoS!',
        'x': 0.5,
        'y': 0.99,
        'xanchor': 'center',
        'yanchor':'top'
